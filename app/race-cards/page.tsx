...
function getChosenWin(grade: number, lane: number, seed: number): string {
    ...
    races: [
      {
        ...
        ground: "Good to Soft",
        runners: [
          { horse:"Alex Rides Her", stable:"Red Stable", grade:2, lane:6, jockey:"Alex Ryder", finish:"DNF" as Finish },
          { horse:"Weight Watchers", stable:"Blue Stable", grade:6, lane:4, jockey:"Dickie Rogers", finish:"1st" as Finish },
          { horse:"Hung Like a Jockey", stable:"Green Stable", grade:5, lane:1, jockey:"Kira McKinstry", finish:"DNF" as Finish },
          { horse:"Zebra", stable:"Pink Stable", grade:2, lane:5, jockey:"Stanley Addis", finish:"2nd" as Finish },
        ] satisfies HistoricRunner[],
        summary:
          "Weight Watchers travelled powerfully throughout and put the race to bed with a sharp move after the last. Zebra stuck on gamely for second once the rest of the field began to crack under pressure.",
      },
    ],
  },
  {
    ...
    races: [
      {
        ...
        ground: "Good to Soft",
        runners: [
          { horse:"Sugar Cube", stable:"Yellow Stable", grade:6, lane:4, jockey:"Goose", finish:"3rd" as Finish },
          { horse:"10 Pints Deep", stable:"Red Stable", grade:6, lane:3, jockey:"Big P", finish:"1st" as Finish },
          { horse:"Lady Tottingham", stable:"Blue Stable", grade:4, lane:2, jockey:"Dickie Rogers", finish:"2nd" as Finish },
          { horse:"Pegasus", stable:"Green Stable", grade:3, lane:6, jockey:"Willy Flanagan", finish:"DNF" as Finish },
          { horse:"George Gallopway", stable:"Purple Stable", grade:5, lane:1, jockey:"Prince Andrew", finish:"4th" as Finish },
          { horse:"Drunk Before Dinner", stable:"White Stable", grade:4, lane:5, jockey:"Aamilah Aswat", finish:"DNF" as Finish },
        ] satisfies HistoricRunner[],
        summary:
...
export default function RaceCardsPage() {
  ...
  const historicRunners: DisplayRunner[] = useMemo(() => {
  ...
  const newRaceRunners: DisplayRunner[] = useMemo(() => {
  ...
  const winner = mode === "historic"
    ? historicRunners.find((r) => r.finish === "1st") || null
    : null;
      ...
      <div className="space-y-6">
        <div className="grid gap-4 md:grid-cols-3">
          <select
            ...
            value={mode}
            onChange={(e) => {
              setMode(e.target.value as "historic" | "new");
              setSelectedHorse("");
            }}
          >
        ...
        <div className="grid gap-6 xl:grid-cols-[1.3fr_.9fr]">
          ...
          <div className="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
            ...
            <div className="mt-5 rounded-2xl border border-amber-300 bg-amber-50 p-4 text-amber-900">
              Historic race cards now show stored runners and summaries. New race cards generate odds automatically from grade + lane.
            </div>
          </div>
        </div>
      </div>
